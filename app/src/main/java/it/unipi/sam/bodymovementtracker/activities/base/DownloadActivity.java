...
import it.unipi.sam.bodymovementtracker.util.download.OnBroadcastReceiverOnDMReceiveListener;
import it.unipi.sam.bodymovementtracker.util.download.RestInfo;
